...
{	
	...
	public JSAdapter create(Object source, JSAdapterType type)
	{
		...
		if (source instanceof org.w3c.dom.Element) {
			...
			case "table":
				return new HTMLTableElement((org.w3c.dom.Element) source, this);
			// Interface HTMLTableCaptionElement
			case "caption":
				return new HTMLTableCaptionElement((org.w3c.dom.Element) source, this);
			// Interface HTMLTableColElement
			case "col": case "colgroup":
				return new HTMLTableColElement((org.w3c.dom.Element) source, this);
			// Interface HTMLTableSectionElement
			case "thead": case "tbody": case "tfoot":
				return new HTMLTableSectionElement((org.w3c.dom.Element) source, this);
			// Interface HTMLTableRowElement
			case "tr":
				return new HTMLTableRowElement((org.w3c.dom.Element) source, this);
